...
const { addEnergyReading, getEnergyReadings,getEnergyTrends,getEnergyHistory,getEnergyInsights, getTodaysEnergy } = require("../controllers/energyController");
...
router.get("/today",getTodaysEnergy);
